...
class analyze:
	...
	def plot_cols(dataframe, col_name, kind='bar'):
	...
	def cat_summary(dataframe, col_name, threshold=False, display=False, plot=False):
	...
	def num_summary(dataframe, col_name, display=False, plot=False,
	...
	def col_target_summary(dataframe, target, col_name, display=False, plot=False):
